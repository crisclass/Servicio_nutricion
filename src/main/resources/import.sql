...
/* Populate tabla servicios */
INSERT INTO servicios (nombre, precio, create_at) VALUES('Nutrición Adulto', 15000, NOW());
INSERT INTO servicios (nombre, precio, create_at) VALUES('Nutrición Crónico', 20000, NOW());
INSERT INTO servicios (nombre, precio, create_at) VALUES('Nutrición Deportiva', 30000, NOW());
INSERT INTO servicios (nombre, precio, create_at) VALUES('Nutrición Gestacional', 25000, NOW());
INSERT INTO servicios (nombre, precio, create_at) VALUES('Otra Patología', 25000, NOW());

/* Creamos algunas horas */
INSERT INTO horas (descripcion, observacion, cliente_id, create_at) VALUES('diabetico', null, 1, NOW());
INSERT INTO horas_items ( hora_id, servicio_id) VALUES( 1, 1);
INSERT INTO horas_items ( hora_id, servicio_id) VALUES( 1, 4);
INSERT INTO horas_items ( hora_id, servicio_id) VALUES( 1, 5);
INSERT INTO horas_items ( hora_id, servicio_id) VALUES( 1, 7);

INSERT INTO horas (descripcion, observacion, cliente_id, create_at) VALUES('hipertenso', 'requiere cuidados', 1, NOW());
INSERT INTO horas_items (cantidad, hora_id, servicio_id) VALUES(3, 2, 6);
